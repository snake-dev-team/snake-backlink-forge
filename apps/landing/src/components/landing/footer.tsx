...
export function Footer() {
  return (
    <footer className="mt-12 border-t border-white/10 py-12">
                ...
                link.external ? (
                  <li key={link.label}>
                    <a
                      ...
                      className="text-white/70 hover:text-cyan-200"
                    >
                      {link.label}
                    </a>
                  </li>
                  ...
                  <li key={link.label}>
                    <Link href={link.href} className="text-white/70 hover:text-cyan-200">
                      {link.label}
                    </Link>
                  </li>
                ),
